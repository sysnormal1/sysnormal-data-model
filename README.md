...
<dependency>
    ...
    <artifactId>sysnormal</artifactId>
...
Importing an entity
````java
import com.sysnormal.libs.db.entities.sysnormal.agents.Agent;
...
## 📚 How to Clone
````bash
git clone https://github.com/sysnormal1/java-db-sysnormal-entities-library.git
